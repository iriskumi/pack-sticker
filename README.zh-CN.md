...
[English README](README.md) · [🚀 在线使用](https://pack-sticker.pages.dev) · [功能介绍](#功能) · [本地运行](#本地开发) · [技术实现](#技术实现)
...
| **AI 去背（快速）** | ISNet FP16 模型，~40MB | 普通照片 |
...
目前仓库还没有提交真实截图。等有当前版本的实际截图后，可以放在这里。
...
> **注意：** AI 去背功能需要从 `staticimgly.com` 下载约 40–80MB 的 ONNX 模型文件，国内网络可能较慢。「去白底」功能完全本地运行，无需下载 AI 模型。
